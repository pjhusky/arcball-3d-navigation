...
namespace ArcBall {
    struct Controls {
        ...
        // "model-matrix" part
        void calcArcMat( const float camTiltRadAngle, const float relMouseX, const float relMouseY, const float relative_mouse_dx, const float relative_mouse_dy, const bool LMBpressed 
        );
